...
class SnailVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        waterDrop.dropTarget = monsterImg
    ...
    func changeGameState() {
        ...
        let rand = arc4random_uniform(3)//give a random number between 2 numbers which will be 0 or 1
